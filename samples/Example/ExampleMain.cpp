...
class CExampleCtrl : public ITcOCFCtrlImpl<CExampleCtrl, CExampleClassFactory>
{
public:
	CExampleCtrl() {};
...
{
	HRESULT hr = E_FAIL;
	TRACE("Example: DllGetTcCtrl(ITcCtrl** ppTcCtrl) \n");

	if (ppTcCtrl != NULL)
	{
		ITcCtrl* pTcCtrl = new IUnknownImpl<CExampleCtrl>;
